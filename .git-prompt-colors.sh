...
override_git_prompt_colors() {
  ...
  GIT_PROMPT_START_USER="[\u@\h] _LAST_COMMAND_INDICATOR_ ${Yellow}${PathShort}${ResetColor}"
  GIT_PROMPT_START_ROOT="[\u@\h] _LAST_COMMAND_INDICATOR_ ${GIT_PROMPT_START_USER}"
